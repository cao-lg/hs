...
print(f"Total schools to add: {len(schools_to_add)}")
...
for s in schools_to_add:
    if s["score"] >= 550:
        ...
        score_ranges["520-540"] += 1
    elif s["score"] >= 500:
        score_ranges["500-520"] += 1
    elif s["score"] >= 480:
        score_ranges["480-500"] += 1
    else:
        score_ranges["<480"] += 1

print("Score distribution:", json.dumps(score_ranges, indent=2, ensure_ascii=False))
